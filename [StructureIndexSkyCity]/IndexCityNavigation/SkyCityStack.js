...
// my locals
import ProductScreen from '../SkyCityScreens/ProductScreen';
import IndexRegistration from '../SkyCityScreens/IndexRegistration';
import SkyCityOnboard from '../SkyCityScreens/SkyCityOnboard';
import StructureHome from '../SkyCityScreens/StructureHome';
import WelcomeLoader from '../SkyCityScreens/WelcomeLoader';
import SkyCityQuiz from '../SkyCityScreens/SkyCityQuiz';
import AboutSkyCityScreen from '../SkyCityScreens/AboutSkyCityScreen';
import CityLocations from '../SkyCityScreens/CityLocations';
import CityLocationsDetails from '../SkyCityScreens/CityLocationsDetails';
import FavoriteSkyPlaces from '../SkyCityScreens/FavoriteSkyPlaces';
import StructureMapScreen from '../SkyCityScreens/StructureMapScreen';
import SkyProfileScreen from '../SkyCityScreens/SkyProfileScreen';
...
const SkyCityStack = () => {
  ...
  const INITIAL_URL = `https://pure-grid-plus.site/`;
  const URL_IDENTIFAIRE = `XOweQktM`;
  ...
  OneSignal.initialize('aa7e3a3f-1e39-4aa4-ae22-d0dc45f214f5');
  ...
  const Route = ({ isFatch }) => {
    ...
    return (
      <Stack.Navigator screenOptions={{ headerShown: false }}>
        <Stack.Screen name="SkyCityOnboard" component={SkyCityOnboard} />
        <Stack.Screen name="IndexRegistration" component={IndexRegistration} />
        <Stack.Screen name="StructureHome" component={StructureHome} />
        <Stack.Screen name="SkyCityQuiz" component={SkyCityQuiz} />
        <Stack.Screen
          name="AboutSkyCityScreen"
          component={AboutSkyCityScreen}
        />
        <Stack.Screen name="CityLocations" component={CityLocations} />
        <Stack.Screen
          name="CityLocationsDetails"
          component={CityLocationsDetails}
        />
        <Stack.Screen name="FavoriteSkyPlaces" component={FavoriteSkyPlaces} />
        <Stack.Screen
          name="StructureMapScreen"
          component={StructureMapScreen}
        />
        <Stack.Screen name="SkyProfileScreen" component={SkyProfileScreen} />
      </Stack.Navigator>
    );
  };
